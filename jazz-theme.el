...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(company-template-field ((,class (:background ,jazz-blue+1 :foreground "black"))))
   `(company-tooltip ((,class (:background ,jazz-green-1 :foreground "black"))))
   `(company-tooltip-annotation ((,class (:background ,jazz-green-1 :foreground ,jazz-green+4))))
   `(company-tooltip-annotation-selection ((,class (:background ,jazz-green+4 :foreground ,jazz-green-1))))
   `(company-tooltip-common ((,class (:foreground "white"))))
   `(company-tooltip-selection ((,class (:background ,jazz-green+4 :foreground "black"))))
   ...
   ;; show-paren (Altered from the original jazz)
