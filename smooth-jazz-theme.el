...
;;
;;; Code
(deftheme smooth-jazz "The Smooth Jazz color theme")
...
(let ((class '((class color) (min-colors 89)))
      ...
      (jazz-yellow+1 "#4B6E00")
      (jazz-yellow   "#669600")
      (jazz-yellow-1 "#669600")
      (jazz-yellow-2 "#8FB245")
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((,class (:foreground ,jazz-bg+3 :background ,jazz-bg+3))))
   ...
   `(compilation-info ((,class (:foreground ,jazz-magenta :underline t))))
   ...
   `(mode-line-buffer-id ((,class (:foreground ,jazz-green-1 :weight bold))))
   ...
   `(region ((,class (:background ,jazz-bg+3 :foreground ,jazz-bg-1))))
   ...
   ;; Customized
   `(font-latex-math-face ((,class (:foreground "dark goldenrod"))))
   `(font-latex-warning-face ((,class (:foreground ,jazz-red))))
   `(font-latex-sectioning-5-face ((,class (:foreground ,jazz-bg :background ,jazz-blue+1))))
   `(font-latex-script-char-face ((,class (:inherit font-latex-math-face))))
   `(preview-face ((,class (:background ,jazz-bg-1))))
   ...
   ;; company (Customized)
   `(company-preview-common ((,class (:background ,jazz-bg+3 :foreground "black"))))
   `(company-template-field ((,class (:background ,jazz-cyan :foreground "black"))))
   `(company-tooltip ((,class (:background ,jazz-yellow-2 :foreground "black"))))
   `(company-tooltip-annotation ((,class (:background ,jazz-yellow-2 :foreground ,jazz-yellow+1))))
   `(company-tooltip-annotation-selection ((,class (:background ,jazz-yellow+1 :foreground ,jazz-yellow-2))))
   `(company-tooltip-common ((,class (:foreground "white"))))
   `(company-tooltip-selection ((,class (:background ,jazz-yellow+1 :foreground "black"))))
   ...
   ;; show-paren
   `(show-paren-mismatch ((,class (:foreground ,jazz-bg :background ,jazz-red-3 :weight bold))))
   `(show-paren-match ((,class (:foreground ,jazz-bg :background ,jazz-blue-1 :weight bold))))
  ...
  (custom-theme-set-variables
   ...
   `(fci-rule-color ,jazz-bg+1)
   
   ;; Colour of visual bell
   `(bell-colour ,jazz-orange)))
